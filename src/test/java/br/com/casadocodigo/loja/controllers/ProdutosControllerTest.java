...
import br.com.casadocodigo.loja.conf.SecutiryConfiguration;

@RunWith(SpringJUnit4ClassRunner.class)
@WebAppConfiguration
@ContextConfiguration(classes = {JPAConfiguration.class, DataSourceConfigurationTest.class, AppWebConfiguration.class, SecutiryConfiguration.class})
@ActiveProfiles("test")
